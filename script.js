...
function displayCandidates(data) {
    ...
    <p><strong>E-mail:</strong> ${candidate['E-mail']}</p>  <!-- opravené -->
    <p><strong>Rok narodenia:</strong> ${candidate['Rok narodenia']}</p>  <!-- opravené -->
    ...
    <p><strong>Aktivita uchádzača:</strong> ${candidate['Aktivita uchádzača']}</p>  <!-- opravené -->
    <a href="${candidate['Životopis']}" target="_blank">Zobraziť životopis</a>  <!-- opravené -->
`;
